...
GopherOS es un **kernel x86 de 32 bits didáctico** que demuestra conceptos fundamentales de sistemas operativos con **código real que compila y corre en QEMU**. No es un diseño en papel ni fragmentos sueltos — es un kernel funcional de punta a punta.
...
git clone https://github.com/tuusuario/gopheros.git
cd gopheros
